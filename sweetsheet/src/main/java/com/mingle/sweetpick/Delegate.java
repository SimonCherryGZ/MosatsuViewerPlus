...
public abstract class Delegate implements View.OnClickListener {
    ...
    public interface OnDelegateToggleListener {
        void onShow();
        void onHide();
    }

    private OnDelegateToggleListener onDelegateToggleListener;

    public void setOnDelegateToggleListener(OnDelegateToggleListener onDelegateToggleListener) {
        this.onDelegateToggleListener = onDelegateToggleListener;
    }
    ...
    protected void showShowdown() {
        ...
        if (onDelegateToggleListener != null) {
            onDelegateToggleListener.onHide();
        }
    }
