...
public class SweetSheet {
    ...
    public interface OnSweetSheetToggleListener {
        void onShow();
        void onHide();
    }

    private OnSweetSheetToggleListener onSweetSheetToggleListener;

    public void setOnSweetSheetToggleListener(OnSweetSheetToggleListener onSweetSheetToggleListener) {
        this.onSweetSheetToggleListener = onSweetSheetToggleListener;
    }
    ...
    private void setup() {
        ...
        mDelegate.setOnDelegateToggleListener(new Delegate.OnDelegateToggleListener() {
            @Override
            public void onShow() {
                if (onSweetSheetToggleListener != null) {
                    onSweetSheetToggleListener.onShow();
                }
            }
            ...
            public void onHide() {
                if (onSweetSheetToggleListener != null) {
                    onSweetSheetToggleListener.onHide();
                }
            }
        });
    }
